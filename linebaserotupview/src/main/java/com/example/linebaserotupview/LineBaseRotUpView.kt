package com.example.linebaserotupview
...
fun Canvas.drawLineBaseRotUp(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLBRUNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineBaseRotUp(scale, w, h, paint)
}

class LineBaseRotUpView(ctx : Context) : View(ctx) {
    ...
    data class LineBaseRotUp(var i : Int) {
