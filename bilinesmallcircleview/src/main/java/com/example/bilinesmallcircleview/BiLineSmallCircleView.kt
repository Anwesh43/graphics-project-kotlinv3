...
class BiLineSmallCircleView(ctx : Context) : View(ctx) {
    ...
    data class BLSCNode(var i : Int = 0, val state : State = State()) {
    ...
    data class BiLineSmallCircle(var i : Int) {

        private var curr : BLSCNode = BLSCNode(0)
