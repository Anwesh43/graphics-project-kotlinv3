package com.example.arcbaselinerotview
...
fun Canvas.drawArcBaseLineRot(scale : Float, w : Float, h : Float, paint : Paint) {
    ...
    drawXY(w / 2, h / 2 - (h / 2) * dsc(3)) {
        ...
        drawArc(RectF(-r, -r, r, r), rot, rot * dsc(0), false, paint)
    }
}
...
fun Canvas.drawABLRNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawArcBaseLineRot(scale, w, h, paint)
}

class ArcBaseLineRotView(ctx : Context) : View(ctx) {
    ...
    data class ArcBaseLineRot(var i : Int) {
    ...
    data class Renderer(var view : ArcBaseLineRotView) {

        private val animator : Animator = Animator(view)
        private val ablr : ArcBaseLineRot = ArcBaseLineRot(0)
