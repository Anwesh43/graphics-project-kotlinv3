package com.example.linesqrotrightview
...
fun Canvas.drawLineSqRotRight(scale : Float, w : Float, h : Float, paint : Paint) {
    ...
    drawXY(w / 2 + (w / 2 + size) * dsc(3) , h / 2) {
        ...
        drawRect(RectF(-size * dsc(1), 0f, 0f, size * dsc(1)), paint)
    }
}
...
fun Canvas.drawLSRRNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineSqRotRight(scale, w, h, paint)
}

class LineSqRotRightView(ctx : Context) : View(ctx) {
    ...
    data class LineSqRotRight(var i : Int) {
    ...
    companion object {
        ...
        fun create(activity : Activity) : LineSqRotRightView {
            val view : LineSqRotRightView = LineSqRotRightView(activity)
