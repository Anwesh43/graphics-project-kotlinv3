package com.example.biarcrotdownview
...
fun Canvas.drawBiArcRotDown(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawBARDNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawBiArcRotDown(scale, w, h, paint)
}

class BiArcRotDownView(ctx : Context) : View(ctx) {
    ...
    data class BiArcRotDown(var i : Int) {
