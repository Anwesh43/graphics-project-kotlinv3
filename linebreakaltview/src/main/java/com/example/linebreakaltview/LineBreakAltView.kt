package com.example.linebreakaltview
...
fun Canvas.drawLineBreakAlt(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLBANode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineBreakAlt(scale, w, h, paint)
}

class LineBreakAltView(ctx : Context) : View(ctx) {
    ...
    data class LBANode(var i : Int = 0, val state : State = State()) {
    ...
    data class LineBreakAlt(var i : Int) {

        private var curr : LBANode = LBANode(0)
