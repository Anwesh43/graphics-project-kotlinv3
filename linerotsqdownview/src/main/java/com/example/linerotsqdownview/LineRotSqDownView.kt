...
class LineRotSqDownView(ctx : Context) : View(ctx) {
    ...
    data class LineRotSqDown(var i : Int = 0, val state : State = State()) {
    ...
    companion object {
        fun create(activity : Activity) : LineRotSqDownView {
            val view : LineRotSqDownView = LineRotSqDownView(activity)
