package com.example.blocklinerightview
...
fun Canvas.drawBlockLineRight(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawBLRNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawBlockLineRight(scale, w, h, paint)
}

class BlockLineRightView(ctx : Context) : View(ctx) {
    ...
    data class BlockLineRight(var i : Int) {

        private var curr : BLRNode = BLRNode(0)
